...
const G_contentSource = {
    ...
    html: [
        {id: 1, type: "公共", title:"html定义", titleClass: "content-modle-title",  discription:"HTML ,是超文本标记语言的英文缩写，是为网页创建和其他可在网页浏览器展示文字、以及非文字如图片、链接、音乐和程序等信息而设计的一种标记语言。", contentClass:"content-modle-discription", linkPath:"source/text.doc", aStyle: "content-modle-more"},
